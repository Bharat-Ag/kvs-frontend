...
import AboutBanner from "../../../../public/assets/images/about/cargos.webp";
...
export default function About() {
  ...
  const [progressValues, setProgressValues] = useState(expertiseData.map(() => 0));
          ...
          <div className="container">
            <div className="about-wrapper">
              ...
              <div className="about-content">
                ...
                <h2 className="sec-heading">Kavishree Exim is a trusted import-export company committed</h2>
                <p className="cmn-text">
                  to delivering reliable, efficient, and compliant global trade solutions. With a strong focus on quality and customer satisfaction, we help businesses connect with international markets through seamless logistics and professional
                  trade support.
                </p>
                <p className="cmn-text">
                  Our operations are built on transparency, precision, and a deep understanding of global trade requirements. From sourcing and documentation to shipment execution, Kavishree Exim ensures every process is handled with care and
                  expertise.
                </p>
              </div>
            </div>
            ...
            <div className="expertise-wrap" ref={sectionRef}>
              {expertiseData.map((item, index) => (
                <div className="expertise-item" key={index}>
                  ...
                  <Progress percent={progressValues[index]} showInfo={false} strokeColor="#cc0001" railColor="#e5e5e5" className="about-progress" />
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="certi-wrapper">
              <AntImage.PreviewGroup>
                <div className="certi-block">
                  <AntImage src="https://placehold.co/370x424" preview={{ src: "https://placehold.co/1024x600" }} alt="Certificate 1" />
                </div>

                <div className="certi-block">
                  <AntImage src="https://placehold.co/370x424" preview={{ src: "https://placehold.co/1024x600" }} alt="Certificate 2" />
                </div>

                <div className="certi-block">
                  <AntImage src="https://placehold.co/370x424" preview={{ src: "https://placehold.co/1024x600" }} alt="Certificate 3" />
                </div>
              </AntImage.PreviewGroup>
            </div>
          </div>
            ...
            <div className="shipping-wrapper">
              ...
              <div className="shipping-content">
                ...
                <div className="wrapper">
                  ...
                  <p className="cmn-text">
                    Kavishree Exim specializes in comprehensive ocean freight solutions, including full container load (FCL), less than container load (LCL), and specialized cargo movements. Backed by a reliable global carrier network and strong
                    industry expertise, we ensure smooth coordination, dependable transit schedules, and cost-efficient shipping solutions for businesses worldwide.
                  </p>
                </div>
              </div>
            </div>
